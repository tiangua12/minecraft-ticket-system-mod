...
public class NetworkManager {
    private static String BASE_PATH = "data/ticketsystem/";
    private static String STATIONS_DIR = BASE_PATH + "stations/";
    private static String LINES_DIR = BASE_PATH + "lines/";
    private static String FARES_DIR = BASE_PATH + "fares/";

    private static String STATIONS_FILE = STATIONS_DIR + "stations.json";
    private static String LINES_FILE = LINES_DIR + "lines.json";
    private static String FARES_FILE = FARES_DIR + "fares.json";
    ...
    /**
     * 设置数据存储的基础路径
     * @param basePath 新的基础路径，必须以斜杠结尾（例如 "saves/world_name/data/ticketsystem/"）
     */
    public static void setBasePath(String basePath) {
        ...
        BASE_PATH = basePath;
        STATIONS_DIR = BASE_PATH + "stations/";
        LINES_DIR = BASE_PATH + "lines/";
        FARES_DIR = BASE_PATH + "fares/";

        STATIONS_FILE = STATIONS_DIR + "stations.json";
        LINES_FILE = LINES_DIR + "lines.json";
        FARES_FILE = FARES_DIR + "fares.json";

        // 重置初始化状态，以便下次initialize使用新路径重新加载数据
        initialized = false;

        TicketSystemMod.LOGGER.info("NetworkManager base path set to: {}", BASE_PATH);
    }
